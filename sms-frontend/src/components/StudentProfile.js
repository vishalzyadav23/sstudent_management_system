...
function StudentProfile() {
  ...
  const [profilePic, setProfilePic] = useState(
    localStorage.getItem("savedProfilePic") || null,
  );
    ...
    const fetchAllData = async () => {
      try {
        ...
        const profileRes = await axios.get(
          `[https://sms-backend-api-gqno.onrender.com](https://sms-backend-api-gqno.onrender.com)/api/students/${studentId}`,
        );
        ...
        const classesRes = await axios.get(
          `[https://sms-backend-api-gqno.onrender.com](https://sms-backend-api-gqno.onrender.com)/api/erp/student/${studentId}/classes`,
        );
        setClasses(classesRes.data.data || classesRes.data || []);

        // 3. Fetch Grades (Bulletproofed wrapper check)
        const marksRes = await axios.get(
          `[https://sms-backend-api-gqno.onrender.com](https://sms-backend-api-gqno.onrender.com)/api/erp/student/${studentId}/marks`,
        );
        setMarks(marksRes.data.data || marksRes.data || []);

        // 4. Fetch Attendance
        const attRes = await axios.get(
          `[https://sms-backend-api-gqno.onrender.com](https://sms-backend-api-gqno.onrender.com)/api/erp/student/${studentId}/attendance`,
        );
  ...
  const handleProfileUpdate = (e) => {
    ...
    axios
      .put(
        `[https://sms-backend-api-gqno.onrender.com](https://sms-backend-api-gqno.onrender.com)/api/students/my-profile/${studentId}`,
        formData,
      )
      .then((res) => {
  ...
  const handlePasswordChange = (e) => {
    ...
    axios
      .post(
        "[https://sms-backend-api-gqno.onrender.com](https://sms-backend-api-gqno.onrender.com)/api/auth/change-password",
  ...
  if (!student)
    return (
      <div
        style={{ textAlign: "center", marginTop: "100px", color: "#ff3b30" }}
      >
  ...
  return (
    <div style={{ animation: "fadeIn 0.5s ease-out" }}>
      ...
      >
        ...
        >
          Student ID: #{student.rollNumber || studentId} | Manage your academics
          and identity.
        </p>
      ...
      <div style={{ minHeight: "40vh" }}>
        ...
        {activeTab === "personal" && (
          <div
            style={{
              animation: "appLaunch 0.4s ease-out",
              maxWidth: "700px",
              margin: "0 auto",
            }}
          >
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    <span
                      className={`dept-badge dept-${(student.department || "other").toLowerCase()}`}
                    >
                    ...
                    >
                      Roll: {student.rollNumber || studentId}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div style={{ marginBottom: "15px" }}>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      background: isEditing ? "white" : "rgba(0,0,0,0.03)",
                      border: isEditing ? "1px solid #007aff" : "none",
                    }}
                  />
                </div>
            ...
            >
              ...
              {pwdMessage && (
                <div
                  style={{
                    background: isPwdError ? "#fee2e2" : "#dcfce7",
                    color: isPwdError ? "#991b1b" : "#166534",
                    padding: "10px",
                    borderRadius: "12px",
                    marginBottom: "15px",
                    textAlign: "center",
            ...
            >
              Official records (Name, Roll No) can only be changed by Admin.
            </p>
          </div>
        )}
              ...
              <div className="year-grid">
                {classes.map((enroll) => (
                  ...
                  >
                    ...
                    >
                      {enroll.course?.courseCode || "N/A"} • Sec{" "}
                      {enroll.section}
                    </div>
                    <div
                      style={{
                    ...
                    >
                      {enroll.course?.courseName || "Unknown Course"}
                    </div>
                    <div
                      style={{
                        fontSize: "14px",
                    ...
                    >
                      {enroll.academicSemester} • {enroll.course?.credits || 0}{" "}
                      Credits
                    </div>
                  </div>
                ))}
        ...
        {activeTab === "grades" && (
          ...
          >
            ...
            {marks.length === 0 ? (
              ...
              >
                No grades have been published for you yet.
              </p>
            ) : (
                    ...
                    <tr key={mark.id}>
                      ...
                      <td style={{ textAlign: "right" }}>
                        <span
                          style={{
                            background:
                              mark.grade === "F" ? "#fee2e2" : "#dcfce7",
                            color: mark.grade === "F" ? "#991b1b" : "#166534",
                            padding: "6px 12px",
                            borderRadius: "8px",
                            fontWeight: "800",
                            fontSize: "16px",
