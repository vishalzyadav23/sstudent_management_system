...
function Login() {
  ...
  const handleLogin = (e) => {
    ...
    axios
      .post(
        "[https://sms-backend-api-gqno.onrender.com](https://sms-backend-api-gqno.onrender.com)/api/auth/login",
        { username, password },
      )
      .then((response) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Access your secure dashboard to manage student records, update
          identities, and monitor academic progress.
        </p>
      </div>
